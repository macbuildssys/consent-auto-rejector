const translations = {
    "EXTENSION_NAME": {
        "en": "connsent-auto-rejector",
        "da": "connsent-auto-rejector",
        "de": "connsent-auto-rejector",
        "pt": "connsent-auto-rejector",
        "fr": "connsent-auto-rejector"
    },
    "EXTENSION_SUBTITLE": {
    ...
    "DISPLAY_DESCRIPTION": {
        "en": "Configure the appearance and behaviour of connsent-auto-rejector",
        "da": "Konfigurer connsent-auto-rejector's udseende og opførsel",
        "de": "Konfiguration des Aussehens und Verhaltens von connsent-auto-rejector",
        "pt": "Configure a aparência e o comportamento do connsent-auto-rejector",
        "fr": "Configurez l'apparence et le comportement de connsent-auto-rejector"
    },
    "CHOICE_DESCRIPTION": {
        "en": "Configure what categories of tracking you would like to allow. connsent-auto-rejector then fills out consent popups as best as possible based on your preferences. All tracking is rejected by default.",
        "da": "Konfigurer hvilke tracking-kategorier du gerne vil tillade. Så vil connsent-auto-rejector udfylde samtykke-popups så godt den kan baseret på dine valg. Som standard bliver alt tracking afvist.",
        "de": "Legen Sie fest, welche Kategorien von Tracking Sie zulassen möchten. connsent-auto-rejector füllt dann, basierend auf Ihren Voreinstellungen, die Zustimmungs-Popups so gut wie möglich aus. Standardmäßig wird jegliches Tracking abgelehnt.",
        "pt": "Configure quais categorias de rastreamento você gostaria de permitir. O connsent-auto-rejector preenche os pop-ups de consentimento da melhor forma possível com base em suas preferências. Todos os rastreamentos são rejeitados por padrão.",
        "fr": "Configurez les catégories de suivi que vous souhaitez autoriser. connsent-auto-rejector remplit ensuite les popups de consentement de la meilleure façon possible en fonction de vos préférences. Tout suivi est rejeté par défaut."
    },
    "RULES_DESCRIPTION": {
        "en": "connsent-auto-rejector comes with a set of rules that tell it how to understand each kind of GDPR consent popup. You can add more sources of rules here - or even create your own list and share it with others!",
        "da": "Sammen med connsent-auto-rejector følger et sæt af regler der beskriver hvordan hver enkelt slags GDPR-samtykke-popup skal behandles. Du kan tilføje flere regel-kilder her - eller oprette din egen liste og dele den med andre!",
        "de": "connsent-auto-rejector wird mit einer Reihe von Regeln geliefert, die ihm sagen, wie es jede Art von GDPR-Einwilligungs-Popup verstehen soll. Sie können hier weitere Quellen für Regeln hinzufügen - oder sogar Ihre eigene Liste erstellen und sie mit anderen teilen!",
        "pt": "O connsent-auto-rejector vem com um conjunto de regras de como entender cada tipo de pop-up de consentimento do GDPR. Você pode adicionar mais regras aqui - ou até mesmo criar sua própria lista e compartilhá-la com outras pessoas!",
        "fr": "connsent-auto-rejector est livré avec un ensemble de règles qui lui indiquent comment comprendre chaque type de popup de consentement GDPR. Vous pouvez ajouter plus de sources de règles ici - ou même créer votre propre liste et la partager avec d'autres!"
    },
    "ADD_LIST": {
        "en": "Add List",
        "da": "Tilføj liste",
    ...
    "ABOUT_DESCRIPTION": {
        "en": "Here you can see how many times a popup has been filled out and just how many clicks connsent-auto-rejector has saved you.",
        "da": "Her kan du se hvor mange gange der er blevet udfyldt en popup for dig, og hvor mange klik connsent-auto-rejector har sparet dig.",
        "de": "Hier können Sie sehen, wie häufig ein Popup ausgefüllt wurde und wie viele Klicks dank connsent-auto-rejector gespart wurden.",
        "pt": "Aqui você pode ver quantas vezes um pop-up foi preenchido e quantos cliques o connsent-auto-rejector economizou para você.",
        "fr": "Ici, vous pouvez voir combien de fois un popup a été remplie et combien de clics connsent-auto-rejector vous a économisés."
    },
    "CLICKS_SAVED": {
        "en": "clicks saved",
        "da": "klik sparet",
    ...
    "OPTIONS_TITLE": {
        "en": "connsent-auto-rejector Options",
        "da": "connsent-auto-rejector indstillinger",
        "de": "connsent-auto-rejector Einstellungen",
        "pt": "Opções do connsent-auto-rejector",
        "fr": "Options de connsent-auto-rejector"
    },
    "ARE_YOU_SURE": {
        "en": "Are you sure?",
        "da": "Er du sikker?",
    ...
    "HIDE_FROM_DETECTION_HELP": {
        "en": "Make sure this element and its children, is never detected by connsent-auto-rejector",
        "da": "Sørg for, at dette element og dets børn aldrig bliver opdaget af connsent-auto-rejector",
        "de": "Stellen Sie sicher, dass dieses Element und seine untergeordneten Elemente niemals von connsent-auto-rejector erkannt werden",
        "pt": "Certifique-se de que este elemento e seus filhos nunca sejam detectados pelo connsent-auto-rejector",
        "fr": "Assurez-vous que cet élément et ses enfants ne sont jamais détectés par connsent-auto-rejector"
    },
    "FORCE_HIDE": {
        "en": "Force hide",
        "da": "Tving skjul",
